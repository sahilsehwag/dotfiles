require('vgit').setup({
	keymaps = {
		...
		['n <leader>ghR'] = 'buffer_reset',
		['n <leader>ghb'] = 'buffer_hunk_preview',
		['n <leader>ghp'] = 'project_hunks_preview',
		['n <leader>ghP'] = 'project_hunks_staged_preview',
		['n <leader>ghq'] = 'project_hunks_qf',

		['n <leader>gdb'] = 'buffer_diff_preview',
		['n <leader>gdp'] = 'project_diff_preview',
		['n <leader>gdh'] = 'buffer_history_preview',
		['n <leader>gdx'] = 'toggle_diff_preference',

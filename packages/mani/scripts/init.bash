...
__mani_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly mani allows handling aliases
    args=("${words[@]:1}")
...
_mani_describe_projects()
{
    ...
    flags+=("--tags-expr=")
    two_word_flags+=("--tags-expr")
    two_word_flags+=("-E")
    local_nonpersistent_flags+=("--tags-expr")
    local_nonpersistent_flags+=("--tags-expr=")
    local_nonpersistent_flags+=("-E")
    flags+=("--target=")
...
_mani_exec()
{
    ...
    flags+=("--forks=")
    two_word_flags+=("--forks")
    two_word_flags+=("-f")
    local_nonpersistent_flags+=("--forks")
    local_nonpersistent_flags+=("--forks=")
    ...
    flags+=("--omit-empty-columns")
    local_nonpersistent_flags+=("--omit-empty-columns")
    flags+=("--omit-empty-rows")
    local_nonpersistent_flags+=("--omit-empty-rows")
    flags+=("--output=")
...
_mani_init()
{
    ...
    flags+=("--sync-gitignore")
    flags+=("-g")
    local_nonpersistent_flags+=("--sync-gitignore")
...
_mani_sync()
{
    ...
    local_nonpersistent_flags+=("--forks=")
    local_nonpersistent_flags+=("-f")
    flags+=("--ignore-sync-state")
    local_nonpersistent_flags+=("--ignore-sync-state")
    flags+=("--parallel")
    flags+=("-p")
    local_nonpersistent_flags+=("--parallel")
    local_nonpersistent_flags+=("-p")
    ...
    local_nonpersistent_flags+=("--paths=")
    local_nonpersistent_flags+=("-d")
    flags+=("--remove-orphaned-worktrees")
    flags+=("-w")
    local_nonpersistent_flags+=("--remove-orphaned-worktrees")
...
_mani_tui()
{
    ...
    flags+=("--reload-on-change")
    flags+=("-r")
    local_nonpersistent_flags+=("--reload-on-change")
    local_nonpersistent_flags+=("-r")
    flags+=("--theme=")
    two_word_flags+=("--theme")
    flags_with_completion+=("--theme")

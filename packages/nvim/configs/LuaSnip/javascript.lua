...
return {
  ...
  snippet('definition.class.generator', {
    ...
    text_node({ ' {', '	constructor(' }),
    insert_node(2, 'params'),
    text_node({ ') {', '		' }),
    insert_node(3, '// constructor body'),
    text_node({ '', '	}', '' }),
    insert_node(4, '// methods'),
    text_node({ '', '}' }),
  }),
  ...
  --  text_node('get '),
  --  insert_node(1, 'property'),
  --  text_node({ '() {', '	' }),
  --  insert_node(2, 'return this._' .. rep(1)[1]),
  --  text_node({ '', '}' }),
  --}),

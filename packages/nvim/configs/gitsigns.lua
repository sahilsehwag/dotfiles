...
vim.api.nvim_set_hl(0, 'GitSignsAddInline',            { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsAddLnInline',          { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsChangeInline',         { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsChangeLnInline',       { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsChangedeleteInline',   { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsChangedeleteLnInline', { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsChangedeleteLnInline', { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsDeleteInline',         { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsDeleteLnInline',       { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsTopdeleteInline',      { link = '' })
vim.api.nvim_set_hl(0, 'GitSignsTopdeleteLnInline',    { link = '' })

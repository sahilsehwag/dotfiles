--on_attach
	local function on_attach(bufnr)
		...
		vim.keymap.set("n", "<C-t>", api.node.open.tab, opts("Open: New Tab"))
		vim.keymap.set("n", "<Tab>", api.node.open.preview, opts("Open Preview"))
		vim.keymap.set("n", "<C-.>", api.tree.toggle_hidden_filter, opts("Toggle Dotfiles"))
		vim.keymap.set("n", "<LocalerLeader>.", api.tree.toggle_hidden_filter, opts("Toggle Dotfiles"))

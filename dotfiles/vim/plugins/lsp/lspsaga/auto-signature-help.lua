...
function module.check_trigger_char(line_to_cursor, trigger_character)
...
function module.lspsaga_open_signature_help()
	...
	for _, client in pairs(clients) do
		...
		if triggered == false then
			triggered = module.check_trigger_char(line_to_cursor, triggers)
		end
	end
...
vim.cmd "autocmd InsertCharPre * lua require('plugins/lsp/lspsaga/auto-signature-help').lspsaga_open_signature_help()"
vim.cmd "augroup end"
